<template>
  ...
  <img class="foto-banner" src="../assets/images/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e está apoiando um celular entre seu rosto e o ombro.">
</header>
</template>
<style scoped>
.banner {
